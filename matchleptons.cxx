...
bool areAbsolute(float reference, float estimate, float absolute) {
    return (estimate > (reference - absolute)) && (estimate < (reference + absolute));
}

bool areRelative(float reference, float estimate, float relative) {
    return (estimate > (reference - relative * reference)) && (estimate < (reference + relative * reference));
}
